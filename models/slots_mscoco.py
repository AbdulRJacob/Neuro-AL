...
from datasets.MSCOCO import MS_COCO
...
if __name__ == "__main__":
    ...
    parser.add_argument("--max_num_obj", type=int, default=19)
    ...
    # training
    parser.add_argument("--exp_name", type=str, default="default_mscoco")
    ...
    # Configure logging
    log_file_path = "./logs/training_log_mscoco.txt"
